...
TEST_CASE_METHOD(sphere, "Sphere Collide", "[sphere]") {
    // touching sphere
    sphere s1(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s2(1, point3(2, 0, 0), vec3(-1, 0, 0), 1, 0);
    REQUIRE(collide(&s1, &s2) == 0.0);

    // colliding sphere
    sphere s3(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s4(1, point3(3, 0, 0), vec3(-1, 0, 0), 1, 0);
    REQUIRE(collide(&s3, &s4) == 0.5);

    // non-colliding sphere
    sphere s5(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s6(1, point3(0, 3, 0), vec3(-1, 0, 0), 1, 0);
    REQUIRE(collide(&s5, &s6) == -1.0);

    // intersecting sphere
    sphere s7(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s8(1, point3(1, 0, 0), vec3(-1, 0, 0), 1, 0);
...
TEST_CASE_METHOD(sphere, "Sphere Update Position", "[sphere]") {
    ...
    sphere s2(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s3(1, point3(2, 0, 0), vec3(-1, 0, 0), 1, 0);
...
TEST_CASE_METHOD(sphere, "Sphere Collision Velocity", "[sphere]") {
    ...
    // one stationary
    sphere s3(1, point3(0, 0, 0), vec3(1, 0, 0), 1, 0);
    sphere s4(1, point3(2, 0, 0), vec3(0, 0, 0), 1, 0);
    ...
    // two stationary
    sphere s5(1, point3(0, 0, 0), vec3(0, 0, 0), 1, 0);
    sphere s6(1, point3(2, 0, 0), vec3(0, 0, 0), 1, 0);
